...
I came to the conclusion that I needed a single place from where to be able to
...
- be able to still use the classical way of logging (to a console) without hassle;
