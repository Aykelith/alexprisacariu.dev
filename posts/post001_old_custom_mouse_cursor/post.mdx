...
Here is a complete example using `sf::CircleShape` as the mouse cursor. I set the origin of the circle to the center because the click position of mouse would fall in the exterior of the circle.
