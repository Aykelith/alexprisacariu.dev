...
seoTitle: "C++ and SFML Tutorial: Building a Simple Piano Application"
seoDescription: "Learn how to create a simple piano application using C++ and SFML. This tutorial covers sound handling, keyboard input, and visual feedback for a virtual piano."
seoKeywords:
   - SFML
   - C++
   - piano application
...
Before you start coding you need to know how SFML handles sounds. In order to play sounds in SFML you need a `sf::SoundBuffer`, which will store audio samples of the sound, and a `sf::Sound` which will load a `sf::SoundBuffer` and after that will play the sound.

More information about SFML handling the sounds you can find here or check SFML API here.
