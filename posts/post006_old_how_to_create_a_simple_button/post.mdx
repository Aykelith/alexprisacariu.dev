...
seoTitle: "Creating a Simple Button Class in SFML and C++"
seoDescription: "A comprehensive guide to creating a reusable button class in SFML. Learn to handle mouse events, hover effects, and click actions in C++."
seoKeywords:
   - SFML
   - C++
   - GUI button
