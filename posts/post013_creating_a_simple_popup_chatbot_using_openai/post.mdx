...
cover: "/imgs/posts/post013/cover-small.png"
invisibleTags:
   - LongPost
publishedOn: "2024-05-21T12:25:43.054Z"
seoTitle: "Tutorial: Building a Voice-Enabled AI Chatbot with OpenAI and WebSockets"
seoDescription: "Learn how to build a popup AI chatbot using OpenAI's ChatGPT, Whisper (STT), and TTS. Covers both a simple HTTP implementation and a real-time WebSocket version."
seoKeywords:
   - OpenAI
   - ChatGPT
   - WebSockets
...
<ClickableImage src="/imgs/posts/post013/presentation.gif" style={{width:'24rem'}} className="post-image center"/>
...
<ClickableImage src="/imgs/posts/post013/first-look.png" style={{width:'31rem',border:'1px solid #c9c9c9'}} className="post-image center"/>
...
<div style={{overflowX: 'auto'}}><ClickableImage src="/imgs/posts/post013/naive_version_activity_diagram.drawio.svg" style={{width:'44rem', maxWidth: 'none'}} className="post-image center"/></div>
...
<ClickableImage src="/imgs/posts/post013/websocket_message_structure.drawio.svg" style={{width:'31rem'}} className="post-image center"/>
 ...
 * is considered that the message was handled and will stop the execution of the
...
There are aspects that were omitted in this post/implementation, such as error
